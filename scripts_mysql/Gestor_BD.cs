...
public class Gestor_BD : MonoBehaviour {
	...
	public InputField txt_contracena;
	...
	//	WWW coneccion = new WWW ("http://localhost:8181/test_juego/puntos.php?user="+txt_usuario.text+"&pass="+txt_contracena.text);
		...
		if (coneccion.text == "200") {
			...
			texo_cuadro.text="Usuario o contraceña incorrectos....!";
		} else {
	...
	IEnumerator datos(){
		...
		WWW coneccion = new WWW ("http://game07environment.000webhostapp.com/game07/datos.php?user=" + txt_usuario.text + "&pass=" + txt_contracena.text);
	...
	IEnumerator registrar(){
		...
		WWW coneccion = new WWW ("http://game07environment.000webhostapp.com/game07/registro.php?user=" + txt_usuario.text + "&pass=" + txt_contracena.text);
		cuadro.SetActive (true);
	...
	IEnumerator ActualizarScore(int nScore){
		...
		WWW coneccion = new WWW ("http://game07environment.000webhostapp.com/game07/score.php?user=" + txt_usuario.text + "&pass=" + txt_contracena.text);
